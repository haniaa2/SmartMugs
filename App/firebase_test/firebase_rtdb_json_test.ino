 ...
 */
 ...
 // Modified by Hani A. Al Majed on 4/23/23
...
#define WIFI_SSID "Hani's Phone"
#define WIFI_PASSWORD "password_test"

// For the following credentials, see examples/Authentications/SignInAsUser/EmailPassword/EmailPassword.ino

/* 2. Define the API Key */
#define API_KEY "AIzaSyDfsN0mgbZYv3i_hn_WYzILe2M6mYX2-Kw"

/* 3. Define the RTDB URL */
#define DATABASE_URL "https://smartmugstest2-default-rtdb.firebaseio.com/" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app

/* 4. Define the user Email and password that alreadey registerd or added in your project */
#define USER_EMAIL "almajed.hani0@gmai.com"
#define USER_PASSWORD "almajed.hani0@gmai.com"
...
void setup()
{
  ...
  Serial.println("Reached this point: setup() done exe");
